...
class PythonBridgeAndroid implements PythonBridge {
  PythonBridgeAndroid({Map<String, String>? assetPaths})
      : _assetPaths = assetPaths ?? {};

  final Map<String, String> _assetPaths;

  static const MethodChannel _channel =
      MethodChannel('securevision/python_bridge');
  static const EventChannel _frameChannel =
      EventChannel('securevision/python_frames');
  static const EventChannel _eventChannel =
      EventChannel('securevision/python_events');
  ...
  Future<List<OnvifDiscoveryResult>> discoverOnvif(
    ...
    throw UnimplementedError('ONVIF discovery is not available on Android.');
  }
